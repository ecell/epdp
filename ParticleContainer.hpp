...
public:
    ...
    virtual structure_id_pair get_structure(structure_type_id_type const& id) const = 0;

    virtual structure_id_pair get_structure(structure_id_type const& id) const = 0;
